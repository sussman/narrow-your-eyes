...
Understand "message", "messages", "text", "text message", "message transcript", "transcribed message", "voice message","voice messages","text messages", "transcribed messages", "voice mail", "play message", "play messages", "read message", "read messages", or "voicemail" as messaging.
...
Instead of doing something with something (called the item) when the metal locker encloses the player:
	if metal locker encloses the item:
		if Amelia is lit:
			continue the action;
		otherwise:
			if the item is Amelia or the item is the orange button:
				continue the action;
			otherwise:
...
title	subtable	description	toggle
"Beta Testers"	--	"John Lodder, Frances Collins-Sussman, Andrew Schultz, Peter Nepstad, Joey Jones, Jenni Polodna, Melvin Rangasamy, Blurglecruncheon, Dan Biemer, and Beth Vanichtheeranont."	--
